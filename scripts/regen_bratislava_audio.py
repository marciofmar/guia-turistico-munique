...
"""
Regenera áudios modificados/novos de Bratislava:
  - bratislava-hrad (observationPoints expandidos — áudio descreve descrição, sem mudança)
  - hlavne-namestie (idem)
  - hviezdoslavovo-namestie (novo POI)
"""
...
FOREIGN_LANG_TAGS = [
    ("Kunsthistorisches Museum", "de-DE"), ("Schloss Schönbrunn", "de-DE"),
    ("Schönbrunn", "de-DE"), ("Stephansdom", "de-DE"), ("Ringstraße", "de-DE"),
    ("Staatsoper", "de-DE"), ("Hofburg", "de-DE"), ("Neuschwanstein", "de-DE"),
    ("Nürnberg", "de-DE"), ("Kaiserburg", "de-DE"), ("Hauptmarkt", "de-DE"),
    ("Budavári Palota", "hu-HU"), ("Halászbástya", "hu-HU"), ("Mátyás-templom", "hu-HU"),
    ("Országház", "hu-HU"), ("Hősök tere", "hu-HU"), ("Széchenyi", "hu-HU"),
    ("Andrássy", "hu-HU"), ("Budavár", "hu-HU"), ("Mátyás", "hu-HU"),
    ("Museo del Prado", "es-ES"), ("Parque del Retiro", "es-ES"),
    ("Puerta del Sol", "es-ES"), ("Plaza Mayor", "es-ES"), ("Velázquez", "es-ES"),
    ("Las Meninas", "es-ES"), ("El Prado", "es-ES"),
]
...
# Apenas o novo POI precisa de áudio gerado
TARGET_POIS = {"hviezdoslavovo-namestie"}

async def main():
    json_path = os.path.join(ROUTES, "bratislava.json")
    ...
    print(f"Gerando {len(tasks)} narracoes de Bratislava...\n")
    for i, (poi_id, text, out) in enumerate(tasks, 1):
        print(f"[{i}/{len(tasks)}] bratislava/{poi_id} -> {os.path.basename(out)}")
        try:
